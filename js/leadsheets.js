...
const FILES = [
  ...
  "I Remember Clifford.png",
  "I Wish I Knew How It Would Feel To Be Free.png",
  "I\u2019Ll Remember April.png",
  "I\u2019M Beginning To See The Light.png",
  "I\u2019ll Never Smile Again.png",
  ...
  "In A Mellow Tone.png",
  "In A Sentimental Mood.png",
  "In The Wee Small Hours Of The Morning.png",
  "It Don\u2019T Mean A Thing (If It Ain\u2019T Got That Swing).png",
  "Joy Spring.png",
  "Like Someone In Love.png",
  "Lush Life.png",
  "Misty.png",
  "Misy.png",
  "My Favorite Things.png",
  "My Foolish Heart.png",
  "My Funny Valentine.png",
  "My One And Only Love.png",
  "Nobody Knows You When You\u2019Re Down And Out.png",
  "Oleo.png",
  "One Note Samba.png",
  "Ornithology.png",
  "Peace.png",
  "Pent Up House.png",
  "Peri\u2019S Scope.png",
  "Pfrancing (No Blues).png",
  "Recorda Me.png",
  "Reflections.png",
  "Satin Doll.png",
  "Scotch And Soda.png",
  "Scrapple From The Apple.png",
  "So What.png",
  "Solar.png",
  "Solitude.png",
  "Some Day My Prince Will Come.png",
  "Some Other Spring.png",
  "Song For My Father.png",
  "Stella By Starlight.png",
  "Straight No Chaser.png",
  "Summertime.png",
  "Take Five.png",
  "Take The A Train.png",
  "The Surrey With The Fringe On Top.png",
  "There Is No Greater Love.png",
  "There Will Never Be Another You.png",
  "Unchain My Heart.png",
  "Waltz For Debby.png",
  "Well You Needn\u2019T.png",
  "When I Fall In Love.png",
  "When Sunny Gets Blue.png",
  "When You Wish Upon A Star.png",
  "Yesterday.png",
  "You Don\u2019T Know What Love Is.png",
  "You\u2019Re Nobody \u2018Til Somebody Loves You.png",
];
